...
from pyfundlib.utils.logger import logger
...
class MarketMakingStrategy(BaseStrategy):
    ...
    def __init__(self, ticker: str = "BTC-USD", params: Optional[dict[str, Any]] = None):
    ...
    def _estimate_volatility(self, returns: Union[pd.Series, np.ndarray]) -> float:
        """
