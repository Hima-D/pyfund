...
class CachedFunction:
    ...
    def __init__(
        ...
        dir_name: str,
        *,
        key_lambda: Optional[Callable[..., str]] = None,
        expire_seconds: Optional[Union[int, Callable[..., int]]] = None,
        expire_days: Optional[int] = 30,
        max_size_mb: Optional[int] = 5000,
        compress: bool = True,
    ):
    ...
    def __call__(self, func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            bypass_cache = not kwargs.get("cache", True)

            # Cache hit?
            if cache_file.exists() and not self._is_expired(cache_file, **kwargs) and not bypass_cache:
                try:
